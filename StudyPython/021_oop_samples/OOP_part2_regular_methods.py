class Employee:
    ...
    # Hardcode example of increase pay method
    def pay_raise(self):
        self.pay = int(self.pay * 1.04)

    # # Example of increase pay method that will cause error
    # def pay_raise(self):
    #     self.pay = int(self.pay * raise_amount)

    # Example of increase pay method accessed through instance
    def pay_raise(self):
        self.pay = int(self.pay * self.raise_amount)

    # Example of increase pay method accessed through class
    def pay_raise(self):
