### Proverka polindromnogo teksta

# str_text = input('Please enter palidrom: rotator ')
...
#######///////////////
#   # Bolee slozhnoe chislo rpoverjaetsja v nachale
#
...
# Домашнее задание:
# Написать программу, которая открывает заданый пользователем файл, считает количество слов,
# и количество уникальных слов (если это слово уже посчитанно, то второй раз не считает)
# Примеры:
# Программа = программа
# Программа, = программа
...
some_string = 'Hello, world, people, hello'.strip(' ')

symbols =[',','.','!','?']
for x in symbols:
    some_string = some_string.replace(x, '')

some_string = some_string.upper().strip()
print(some_string)
